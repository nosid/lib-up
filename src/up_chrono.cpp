...
auto up_chrono::to_string(const system_time_point& value) -> std::string
{
    return to_string(value.time_since_epoch());
}

auto up_chrono::to_string(const steady_time_point& value) -> std::string
{
    return to_string(value.time_since_epoch());
}

auto up_chrono::to_string(const duration& value) -> std::string
{
