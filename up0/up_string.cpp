...
template class up_string::repr<false>;
template class up_string::repr<true>;

template class up_string::basic_string<up_string::repr<false>, false>;
template class up_string::basic_string<up_string::repr<true>, true>;
